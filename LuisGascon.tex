...
{\textbf{Parking with confidence using ANPR} $|$ \emph{Flask, Sqlite, easyOCR, openCV, thefuzz}}{}
\resumeItemListStart
\resumeItem{Enhanced OCR accuracy by applying techniques such as grayscale conversion, Gaussian blurring, edge detection, and fuzzy string matching.}
\resumeItem{}
\resumeItem{}

...
\resumeItemListStart
\resumeItem{Develop reactive notebooks using Marimo, a Jupyter alternative, to enhance the marketing team's data analysis capabilities.}
\resumeItem{Create Python scripts to connect to a MongoDB instance and download JSON data, enabling seamless integration with notebooks and eliminating the need for a development environment setup for the marketing team.}
\resumeItem{Collaborated with the marketing team }
\resumeItemListEnd

...
\resumeSubheading
{Towson University}{Towson, MD}
{General Computer Science Teaching Assistant}
{Aug 2024 \textbf{--} Present}
\resumeItemListStart
\resumeItem{Instructed students on binary, decimal, and hexadecimal counting systems, and mastering the conversion techniques between them}
\resumeItem{Assisted students in lab sessions by teaching them how to use development tools such as text editors and compilers, allowing them to focus on applying classroom knowledge in practice}
\resumeItem{Provided one-on-one tutoring and academic support to students, resulting in a measurable improvement in class average grades and student satisfaction}
\resumeItem{Assisted in the grading and assessment of assignments and exams, developing a keen eye for detail and provided detailed unbiased feedback to enhance student's comprehension.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Hosted workshops such as easing students into using the terminal and use cases of markup languages}
\resumeItem{Led weekly mock sessions on data structures and algorithms to improve students’ technical interview performance}
\resumeItemListEnd
\resumeSubHeadingListEnd

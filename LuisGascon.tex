...
\begin{center}
  ...
  $|$
  \faGlobe \hspace{.5pt} \href{https://lgascon.xyz}{https://lgascon.xyz}
  % $|$
...
\small{\item{
              \textbf{Languages}{: Python, Java, HTML, CSS, TypeScript, Swift} \\
              \vspace{3pt}
              \textbf{Technologies}{: Linux, Git, Docker, PostgreSQL, MongoDB, Jest} \\ \vspace{3pt}
...
\resumeItemListStart
\resumeItem{Built data pipelines to extract production data from MongoDB Atlas, map document relationships across collections, and construct a normalized relational dataframe for analysis.}
\resumeItem{Design and implement interactive data visualizations using Altair, transforming raw data into actionable insights.}
\resumeItem{Utilized the Google Analytics SDK in Python to perform data analysis, extracting key metrics and identifying trends to inform business decisions.}
\resumeItem{Created an interactive dashboard hosted on AWS using a custom container image running a Marimo notebook connected to the production database that allowed the marketing team to view up to date custom queries.}
...
\resumeItem{Developed comprehensive unit and end-to-end tests with Jest, achieving high code coverage and ensuring API endpoint reliability.}
...
\resumeItemListStart
\resumeItem{Developed an iOS application to aggregate Towson University events from multiple sources, providing users with a comprehensive view of events.}
\resumeItem{Transformed JSON data from various sources into a standardized format, ensuring consistent data representation and ease of use.}
...
{Master's of Science in Computer Science \textbf{4.0/4.0}}{December 2026}
\resumeSubheading
{Towson University}{Towson, MD}
...
\resumeItemListEnd
\resumeItem{\textbf{Data Analytics Competition}}
\resumeItemListStart
\resumeItem{Awarded 1st place for Towson University's data analytics competition}
\resumeItem{Developed interactive data visualizations and computed statistical insights using Polars, NumPy, and Vega-Altair to support data-driven analysis}
\resumeItemListEnd
\resumeSubHeadingListEnd

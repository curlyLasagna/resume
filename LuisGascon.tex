...
\resumeItem{Enhanced a Visual Basic app that generates static HTML files for the department's website much faster by skipping over unchanged directories}
